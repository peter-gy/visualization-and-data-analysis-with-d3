...
!(function (t, n) {
    ...
    function h(t, n) {
        ...
        if (void 0 === n)
            for (let n of t)
                null != n && (n = +n) >= n && ((e = n - i), (i += e / ++r), (o += e * (n - i)));
        else {
            let a = -1;
            for (let u of t)
                null != (u = n(u, ++a, t)) &&
    ...
    function p(t, n) {
        ...
        if (void 0 === n)
            for (const n of t)
                null != n &&
                    (void 0 === e ? n >= n && (e = r = n) : (e > n && (e = n), r < n && (r = n)));
        else {
            let i = -1;
            for (let o of t)
                null != (o = n(o, ++i, t)) &&
                    (void 0 === e ? o >= o && (e = r = o) : (e > o && (e = o), r < o && (r = o)));
        }
        return [e, r];
    }
    class g {
    ...
    function q(t, n, e) {
        ...
        if (((r = n < t) && ((i = t), (t = n), (n = i)), 0 === (a = R(t, n, e)) || !isFinite(a)))
            return [];
        if (a > 0) {
            let e = Math.round(t / a),
                r = Math.round(n / a);
            for (e * a < t && ++e, r * a > n && --r, o = new Array((i = r - e + 1)); ++u < i; )
                o[u] = (e + u) * a;
        } else {
            a = -a;
            let e = Math.round(t * a),
    ...
    function U() {
        ...
        function r(r) {
            ...
            if (!Array.isArray(h)) {
                const t = l,
                    e = +h;
                if ((n === p && ([s, l] = O(s, l, e)), (h = q(s, l, e))[h.length - 1] >= l))
                    if (t >= l && n === p) {
                        const t = R(s, l, e);
                        isFinite(t) &&
                            (t > 0
        ...
        return (
            ...
            (r.thresholds = function (t) {
                return arguments.length
                    ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? C(N.call(t)) : C(t)), r)
                    : e;
            }),
            r
        );
    ...
    function G(t, n) {
        ...
        if (void 0 === n)
            for (const n of t)
                ++i, null != n && (e < n || (void 0 === e && n >= n)) && ((e = n), (r = i));
        else
            for (let o of t)
                null != (o = n(o, ++i, t)) &&
                    (e < o || (void 0 === e && o >= o)) &&
    ...
    gt.prototype = pt.prototype = {
        ...
        on: function (t, n) {
            ...
            for (; ++o < a; ) if ((e = (t = i[o]).type) && (e = vt(r[e], t.name))) return e;
        },
        copy: function () {
            var t = {},
                n = this._;
    ...
    Pn.prototype = zn.prototype = {
        ...
        data: function (t, n) {
            ...
            for (
                var o = i.length, a = new Array(o), u = new Array(o), c = new Array(o), f = 0;
                f < o;
                ++f
            ) {
                var s = r[f],
        ...
        merge: function (t) {
            ...
            for (
                ...
                for (
                    var c, f = n[u], s = e[u], l = f.length, h = (a[u] = new Array(l)), d = 0;
                    d < l;
                    ++d
                )
                    (c = f[d] || s[d]) && (h[d] = c);
        ...
        style: function (t, n, e) {
            return arguments.length > 1
                ? this.each(
                      (null == n ? Zt : 'function' == typeof n ? Qt : Kt)(t, n, null == e ? '' : e)
                  )
                : Jt(this.node(), t);
        },
            ...
            (n = re.exec(t))
                ? ((e = n[1].length),
                  ...
                  6 === e
                      ...
                      : 8 === e
                      ? ge((n >> 24) & 255, (n >> 16) & 255, (n >> 8) & 255, (255 & n) / 255)
                      : 4 === e
                      ? ge(
                            ((n >> 12) & 15) | ((n >> 8) & 240),
                            ((n >> 8) & 15) | ((n >> 4) & 240),
    ...
    var Cr = Nr(
            function (t) {
                const n = new ('function' == typeof DOMMatrix ? DOMMatrix : WebKitCSSMatrix)(
                    t + ''
                );
        ...
        Pr = Nr(
            function (t) {
                return null == t
                    ? Er
                    : (Tr || (Tr = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
    ...
    function ii() {
        ti(), ++Gr;
        for (var t, n = Hr; n; ) (t = Zr - n._time) >= 0 && n._call.call(null, t), (n = n._next);
        --Gr;
    }
    function oi() {
                ...
                (function () {
                    ...
                    for (; e; )
                        e._call
                            ...
                            : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Hr = n)));
                    (Xr = t), ui(r);
                })(),
                (Zr = 0);
        }
        ...
        Gr ||
            ...
            t - Zr > 24
                ? (t < 1 / 0 && (Vr = setTimeout(oi, t - Qr.now() - Kr)),
                  $r && ($r = clearInterval($r)))
                : ($r || ((Wr = Qr.now()), ($r = setInterval(ai, 1e3))), (Gr = 1), Jr(oi)));
    }
    function ci(t, n, e) {
        var r = new ei();
        return (
    ...
    ei.prototype = ri.prototype = {
        ...
        restart: function (t, n, e) {
            ...
            (e = (null == e ? ti() : +e) + (null == n ? 0 : +n)),
                this._next || Xr === this || (Xr ? (Xr._next = this) : (Hr = this), (Xr = this)),
                (this._call = t),
                (this._time = e),
                ui();
        },
    ...
    function bi(t, n) {
        var e;
        return (
            'number' == typeof n ? _r : n instanceof de ? sr : (e = de(n)) ? ((n = e), sr) : wr
        )(t, n);
    }
    function mi(t) {
        return function () {
    ...
    ji.prototype = Hi.prototype = {
        ...
        transition: function () {
            for (
                var t = this._name, n = this._id, e = Xi(), r = this._groups, i = r.length, o = 0;
                o < i;
                ++o
            )
    ...
    var _o = [null];
    var bo = (t) => () => t;
    function mo(t, { sourceEvent: n, target: e, selection: r, mode: i, dispatch: o }) {
        Object.defineProperties(this, {
            type: { value: t, enumerable: !0, configurable: !0 },
            sourceEvent: { value: n, enumerable: !0, configurable: !0 },
        ...
        function h(e) {
            if ((!n || e.touches) && r.apply(this, arguments)) {
                ...
                if (e.touches) (F.moved = I), (F.ended = B);
                    ...
                    var O = Dn(e.view).on('mousemove.brush', I, !0).on('mouseup.brush', B, !0);
            ...
            function I(t) {
                for (const n of t.changedTouches || [t])
                    for (const t of D) t.identifier === n.identifier && (t.cur = In(n, _));
                if (z && !y && !v && 1 === D.length) {
                    const t = D[0];
                    ...
                    case To:
                        D[1]
                            ...
                            : (x < 0
                                  ...
                                  : x > 0 && ((C = ko(S - l, No(k - l, C))), (a = i), (h = l + C)),
                              w < 0
                                  ? ((P = ko(E - u, No(N - u, P))), (c = u + P), (p = d))
                                  : w > 0 && ((P = ko(E - d, No(N - d, P))), (c = u), (p = d + P)));
                        break;
                    case So:
                        x && ((a = ko(S, No(k, i - C * x))), (h = ko(S, No(k, l + C * x)))),
                            w && ((c = ko(E, No(N, u - P * w))), (p = ko(E, No(N, d + P * w))));
                }
                h < a &&
                    ((x *= -1),
                    (r = i),
        ...
        return (
            ...
            (l.prototype = {
                ...
                brush: function (t, n) {
                    ...
                    return (
                        0 == --this.active && (delete this.state.emitter, this.emit('end', t, n)),
                        this
                    );
                },
                emit: function (n, e, r) {
                    ...
                    if (t) {
                        ...
                        for (const r of t)
                            if (r < 0) {
                                ...
                                (
                                    l[e * c + r] || (l[e * c + r] = { source: null, target: null })
                                ).source = {
                                    index: e,
                                    startAngle: n,
            ...
            if (null === this._x1) this._ += 'M' + (this._x1 = t) + ',' + (this._y1 = n);
                ...
                if (Math.abs(s * u - c * f) > aa && i) {
                    var h = e - o,
                        ...
                        b = _ / v,
                        m = _ / y;
                    Math.abs(b - 1) > aa && (this._ += 'L' + (t + b * f) + ',' + (n + b * s)),
                        (this._ +=
                            'A' +
                            i +
                            ',' +
    ...
    var wa = (t) => () => t;
    function Ma(t, n) {
        for (var e, r = -1, i = n.length; ++r < i; ) if ((e = Aa(t, n[r]))) return e;
        return 0;
    }
    function Aa(t, n) {
    ...
    function ka() {
        ...
        function o(e, i) {
            ...
            return (
                (function (e, r, i) {
                    ...
                    for (; ++o < t - 1; ) (c = f), (f = e[o + 1] >= r), Ea[c | (f << 1)].forEach(p);
                    Ea[f << 0].forEach(p);
                    for (; ++u < n - 1; ) {
                        for (
                            o = -1,
        ...
        return (
            ...
            (i.thresholds = function (t) {
                return arguments.length
                    ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? wa(ma.call(t)) : wa(t)),
                      i)
                    : e;
            }),
            (i.smooth = function (t) {
    ...
    class Fa {
        ...
        update() {
            ...
            for (let n = 0; n < o; n++) this._dists[n] = Oa(t[2 * n], t[2 * n + 1], M.x, M.y);
            ...
            for (let o, a, u = 0; u < this._ids.length; u++) {
                ...
                let g,
                    y = l;
                for (; (g = e[y]), !Ua(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]); )
                    if (((y = g), y === l)) {
                        y = -1;
                        break;
                    }
                ...
                let _ = e[y];
                for (; (g = e[_]), Ua(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]); )
                    (v = this._addTriangle(_, c, g, r[c], -1, r[_])),
                        ...
                        (_ = g);
                if (y === l)
                    for (; (g = n[y]), Ua(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]); )
    ...
    function Ua(t, n, e, r, i, o) {
        return (Ia(i, o, t, n, e, r) || Ia(t, n, e, r, i, o) || Ia(e, r, i, o, t, n)) < 0;
    }
        ...
        *neighbors(t) {
        ...
        _cell(t) {
            ...
            do {
                ...
                if ((a.push(n[2 * e], n[2 * e + 1]), (u = u % 3 == 2 ? u - 2 : u + 1), i[u] !== t))
                    break;
                u = r[u];
            } while (u !== o && -1 !== u);
            return a;
        ...
        *neighbors(t) {
        ...
        _step(t, n, e) {
            ...
            do {
                ...
                if ((l < s && ((s = l), (f = r)), (h = h % 3 == 2 ? h - 2 : h + 1), u[h] !== t))
                    break;
                if (((h = a[h]), -1 === h)) {
                    if (
                        ((h = i[(o[t] + 1) % i.length]),
    ...
    function uu(t) {
        ...
        return isNaN(t)
            ...
            : (function (t) {
                  ...
                  au(t.getUTCDate(), 2) +
                  (i
                      ? 'T' + au(n, 2) + ':' + au(e, 2) + ':' + au(r, 2) + '.' + au(i, 3) + 'Z'
                      : r
    ...
    function qu(t) {
        return (n, e) => Nu(n, e).then((n) => new DOMParser().parseFromString(n, t));
    }
    ...
    (Xu.copy = function () {
        ...
        (Xu.addAll = function (t) {
            ...
            for (this.cover(c, f).cover(s, l), e = 0; e < o; ++e) Iu(this, a[e], u[e], t[e]);
            return this;
        }),
        ...
        (Xu.visit = function (t) {
            var n,
                ...
                u = [],
                c = this._root;
            for (c && u.push(new Uu(c, this._x0, this._y0, this._x1, this._y1)); (n = u.pop()); )
        ...
        (Xu.visitAfter = function (t) {
            var n,
                ...
                r = [];
            for (
                this._root && e.push(new Uu(this._root, this._x0, this._y0, this._x1, this._y1));
                (n = e.pop());
    ...
    function pc(t) {
        ...
        function l(t) {
            ...
            function M(t) {
                ...
                switch (
                    (g && d && ((t = r(S + t, S.length ? p - M.length : 1 / 0)), (S = '')), e)
                ) {
                    case '<':
                        t = h + t + M + S;
                        break;
    ...
    var Xc = {
            ...
            FeatureCollection: function (t, n) {
                for (var e = t.features, r = -1, i = e.length; ++r < i; ) Hc(e[r].geometry, n);
            }
        },
        Gc = {
            Sphere: function (t, n) {
            ...
            MultiLineString: function (t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) Vc(e[r], n, 0);
            },
            Polygon: function (t, n) {
                $c(t.coordinates, n);
            },
            MultiPolygon: function (t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) $c(e[r], n);
            },
    ...
    function bs(t, n, e, r, i, o) {
        if (e) {
            ...
            null == i
                ? ((i = n + r * Ac), (o = n - c / 2))
                : ((i = ms(a, i)), (o = ms(a, o)), (r > 0 ? i < o : i > o) && (i += r * Ac));
    ...
    function As(t, n, e, r, i) {
        ...
        if (
            ...
            for (c.sort(n), Ts(u), Ts(c), o = 0, a = c.length; o < a; ++o) c[o].e = e = !e;
            for (var f, s, l = u[0]; ; ) {
            ...
            function b() {
                ...
                if ((u.pop(), o.push(u), (u = null), d))
                    if (1 & c) {
                        ...
                        d > 1 && 2 & c && h.push(h.pop().concat(h.shift())), a.push(h.filter(Ns));
            }
            return h;
        };
    }
    ...
    function Us(t, n, e, r) {
        ...
        return function (a) {
            ...
            function M(o, a) {
                var u = i(o, a);
                if ((f && s.push([o, a]), v))
                    (l = o), (h = a), (d = u), (v = !1), u && (b.lineStart(), b.point(o, a));
        ...
        return (
            ...
            (v.outline = function () {
                return {
                    type: 'Polygon',
                    coordinates: [
                        s(r).concat(l(a).slice(1), s(e).reverse().slice(1), l(u).reverse().slice(1))
                    ]
                };
            }),
            (v.extent = function (t) {
            ...
            (E.clipExtent = function (t) {
                return arguments.length
                    ? ((T =
                          null == t
                              ? ((A = r = i = o = null), fl)
                              : Us((A = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
                      C())
                    : null == A
                    ? null
                    : [
        ...
        return (
            ...
            (i.clipExtent = function (t) {
                return arguments.length
                    ? (null == t
                          ? (f = n = e = r = null)
                          : ((f = +t[0][0]), (n = +t[0][1]), (e = +t[1][0]), (r = +t[1][1])),
                      s())
                    : null == f
                    ? null
                    : [
        ...
        return (
            (o.invert = function (t, n) {
                var e = i - n,
                    ...
                    a = Nc(t, Ec(e)) * Oc(e);
                return (
                    e * r < 0 && (a -= xc * Oc(t) * Oc(e)), [a / r, 2 * kc(Rc(i / o, 1 / r)) - wc]
                );
            }),
            o
        );
        ...
        return (
            (o.invert = function (t, n) {
                var e = i - n,
                    o = Nc(t, Ec(e)) * Oc(e);
                return (
                    e * r < 0 && (o -= xc * Oc(t) * Oc(e)), [o / r, i - Oc(r) * Ic(t * t + e * e)]
                );
            }),
            o
        );
    ...
    function Qh(t, n) {
        var e, r;
        if (nd(n, t)) return [n];
        for (e = 0; e < t.length; ++e) if (Jh(n, t[e]) && nd(rd(t[e], n), t)) return [t[e], n];
    ...
    function bd(t, n, e, r, i) {
        for (
            var o, a = t.children, u = -1, c = a.length, f = t.value && (r - n) / t.value;
            ++u < c;
    ...
    (Rh.invert = function (t, n) {
        ...
        (Oh.invert = function (t, n) {
            ...
            do {
                ...
                r -= e =
                    (r *
                        (1.007226 + o * (0.015085 + a * (0.028874 * o - 0.044475 - 0.005916 * a))) -
                        n) /
            ...
            return [
                t /
                    (0.8707 +
                        (o = r * r) *
                            (o * (o * o * o * (0.003971 - 0.001529 * o) - 0.013791) - 0.131979)),
                r
            ];
        }),
        (Ih.invert = xh(Yc)),
    ...
    function Cd(t, n, e, r, i) {
        for (
            var o, a = t.children, u = -1, c = a.length, f = t.value && (i - e) / t.value;
            ++u < c;
        ...
        return (
            ...
            e &&
                ((i.count = function (n, r) {
                    return Ip.setTime(+n), Up.setTime(+r), t(Ip), t(Up), Math.floor(e(Ip, Up));
                }),
                (i.every = function (t) {
                    return (
                        (t = Math.floor(t)),
    ...
    var Zp = Bp(
        ...
        eg = Bp(
            ...
            (t, n) => (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Hp) / Gp,
            (t) => t.getDate() - 1
        ),
        rg = eg.range;
    function ig(t) {
    ...
    function ey(t) {
        ...
        function M(t, n) {
            return function (e) {
                ...
                return 'Z' in o ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), ty(o)) : Jg(o);
            };
        }
        function A(t, n, e, r) {
    ...
    function Zy(t, n) {
        var e = t.getDay();
        return cy((t = e >= 4 || 0 === e ? fg(t) : fg.ceil(t)).getFullYear() % 1e4, n, 4);
    }
    function Ky(t) {
        var n = t.getTimezoneOffset();
        return (n > 0 ? '-' : ((n *= -1), '+')) + cy((n / 60) | 0, '0', 2) + cy(n % 60, '0', 2);
    }
    function Qy(t, n) {
    ...
    function sv(t, n) {
        return (t = fv(t)), cy(qg.count(Gg(t), t) + (4 === Gg(t).getUTCDay()), n, 2);
    }
    function lv(t) {
        return t.getUTCDay();
    }
    ...
    function yv(t, n) {
        var e = t.getUTCDay();
        return cy((t = e >= 4 || 0 === e ? qg(t) : qg.ceil(t)).getUTCFullYear() % 1e4, n, 4);
    }
    function vv() {
        return '+0000';
    }
    ...
    function kv() {
        ...
        function f(n) {
            return null == n || isNaN((n = +n))
                ? i
                : u(0 === e ? 0.5 : ((n = (r(n) - t) * e), c ? Math.max(0, Math.min(1, n)) : n));
        }
        function s(t) {
            return function (n) {
                var e, r;
    ...
    var qv = Dv('1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf'),
        ...
        Lv = Dv('8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f'),
    ...
    function wb(t, n, e, r, i, o, a, u) {
        var c = e - t,
            ...
            l = u - o,
            h = l * c - s * f;
        if (!(h * h < lb)) return [t + (h = (s * (n - o) - l * (t - i)) / h) * c, n + h * f];
    }
    function Mb(t, n, e, r, i, o, a) {
        ...
        return (
            ...
            { cx: A, cy: T, x01: -s, y01: -l, x11: A * (i / x - 1), y11: T * (i / x - 1) }
        );
    }
    ...
    function Cb(t, n) {
        ...
        return (
            ...
            (a.x = function (n) {
                return arguments.length ? ((t = 'function' == typeof n ? n : rb(+n)), a) : t;
            }),
            (a.y = function (t) {
                return arguments.length ? ((n = 'function' == typeof t ? t : rb(+t)), a) : n;
            }),
            (a.defined = function (t) {
                return arguments.length ? ((e = 'function' == typeof t ? t : rb(!!t)), a) : e;
            }),
            (a.curve = function (t) {
    ...
    function Pb(t, n, e) {
        ...
        return (
            ...
            (c.x0 = function (n) {
                return arguments.length ? ((t = 'function' == typeof n ? n : rb(+n)), c) : t;
            }),
            (c.x1 = function (t) {
                return arguments.length
            ...
            (c.y0 = function (t) {
                return arguments.length ? ((n = 'function' == typeof t ? t : rb(+t)), c) : n;
            }),
            (c.y1 = function (t) {
                return arguments.length
            ...
            (c.defined = function (t) {
                return arguments.length ? ((i = 'function' == typeof t ? t : rb(!!t)), c) : i;
            }),
            (c.curve = function (t) {
    ...
    function jb(t) {
        ...
        return (
            ...
            (a.x = function (t) {
                return arguments.length ? ((r = 'function' == typeof t ? t : rb(+t)), a) : r;
            }),
            (a.y = function (t) {
                return arguments.length ? ((i = 'function' == typeof t ? t : rb(+t)), a) : i;
            }),
            (a.context = function (t) {
    ...
    var Vb = {
        ...
        im = {
            draw: function (t, n) {
                ...
                t.moveTo(0, 2 * e), t.lineTo(-rm * e, -e), t.lineTo(rm * e, -e), t.closePath();
            }
        },
        om = -0.5,
        am = Math.sqrt(3) / 2,
    ...
    function Rm(t, n, e) {
        var r = t._x1 - t._x0,
            ...
            a = (e - t._y1) / (i || (r < 0 && -0)),
            u = (o * i + a * r) / (r + i);
        return (qm(o) + qm(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
    }
    function Fm(t, n) {
        var e = t._x1 - t._x0;
    ...
    (ex.prototype = tx.prototype),
                ...
                if ((u || (u = c = fa()), l < s && ((f = l), (l = s), (s = f)), l > lb))
                    if (p > pb - lb)
                        u.moveTo(l * ab(h), l * fb(h)),
                            u.arc(0, 0, l, h, d, !g),
                            s > lb && (u.moveTo(s * ab(d), s * fb(d)), u.arc(0, 0, s, d, h, g));
                    else {
                        var y,
                            v,
                            _ = h,
                        ...
                        M > lb
                            ? k > lb
                                ? ((y = Mb(I, U, P, z, l, k, g)),
                                  ...
                                  k < S
                                      ? u.arc(y.cx, y.cy, k, ob(y.y01, y.x01), ob(v.y01, v.x01), !g)
                                      : (u.arc(
                                            y.cx,
                                            y.cy,
                                            k,
            ...
            return (
                (c.centroid = function () {
                    var e = (+t.apply(this, arguments) + +n.apply(this, arguments)) / 2,
                        r = (+i.apply(this, arguments) + +o.apply(this, arguments)) / 2 - hb / 2;
                ...
                (c.cornerRadius = function (t) {
                    return arguments.length ? ((e = 'function' == typeof t ? t : rb(+t)), c) : e;
                }),
                ...
                (c.endAngle = function (t) {
                    return arguments.length ? ((o = 'function' == typeof t ? t : rb(+t)), c) : o;
                }),
                (c.padAngle = function (t) {
                    return arguments.length ? ((a = 'function' == typeof t ? t : rb(+t)), c) : a;
                }),
                (c.context = function (t) {
        ...
        (t.contourDensity = function () {
            ...
            function l(r) {
                ...
                r.forEach(function (r, o, s) {
                    ...
                    Na({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
                    Ca({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
                    Na({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
                    Ca({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
                    Na({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
                    Ca({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a);
        ...
        (t.drag = function () {
            ...
            function v(t) {
                var n,
                    ...
                    r = t.changedTouches,
                    i = r.length;
                for (n = 0; n < i; ++n) (e = c[r[n].identifier]) && (Bn(t), e('drag', t, r[n]));
            }
            function _(t) {
                var n,
                    e,
        ...
        (t.forceManyBody = function () {
            ...
            function h(t, o, f, s) {
                ...
                if (!(t.length || p >= u)) {
                    ...
                    do {
                        t.data !== n &&
                            ((d = (i[t.data.index] * r) / p), (n.vx += l * d), (n.vy += h * d));
                    } while ((t = t.next));
                }
            }
            return (
        ...
        (t.interpolateRainbow = function (t) {
            ...
            return ($_.h = 360 * t - 100), ($_.s = 1.5 - 1.5 * n), ($_.l = 0.8 - 0.9 * n), $_ + '';
        }),
        ...
        (t.pie = function () {
            ...
            return (
                ...
                (a.padAngle = function (t) {
                    return arguments.length ? ((o = 'function' == typeof t ? t : rb(+t)), a) : o;
                }),
                a
            );
        }),
        ...
        (t.pointers = function (t, n) {
            return (
                t.target &&
                    ((t = On(t)), void 0 === n && (n = t.currentTarget), (t = t.touches || [t])),
        ...
        (t.stack = function () {
            ...
            return (
                ...
                (i.value = function (t) {
                    return arguments.length ? ((r = 'function' == typeof t ? t : rb(+t)), i) : r;
                }),
                (i.order = function (t) {
                    return arguments.length
                        ? ((n = null == t ? Xm : 'function' == typeof t ? t : rb(Array.from(t))), i)
                        : n;
                }),
                (i.offset = function (t) {
        ...
        (t.symbol = function (t, n) {
            ...
            return (
                ...
                (r.type = function (n) {
                    return arguments.length ? ((t = 'function' == typeof n ? n : rb(n)), r) : t;
                }),
                (r.size = function (t) {
                    return arguments.length ? ((n = 'function' == typeof t ? t : rb(+t)), r) : n;
                }),
        ...
        (t.thresholdFreedmanDiaconis = function (t, n, e) {
            return Math.ceil((e - n) / (2 * (H(t, 0.75) - H(t, 0.25)) * Math.pow(c(t), -1 / 3)));
        }),
        ...
        (t.zoom = function () {
            ...
            function v(t, n) {
                return (n = Math.max(c[0], Math.min(c[1], n))) === t.k ? t : new tx(n, t.x, t.y);
            }
            function _(t, n, e) {
                var r = n[0] - e[0] * t.k,
                    i = n[1] - e[1] * t.k;
            ...
            function A(t, ...n) {
                if (!e && r.apply(this, arguments)) {
                    var i = x(this, n, !0).event(t),
                        ...
                        s = t.clientX,
                        l = t.clientY;
                    Yn(t.view), rx(t), (i.mouse = [u, this.__zoom.invert(u)]), gi(this), i.start();
                }
                function h(t) {
                    if ((ix(t), !i.moved)) {
                        var n = t.clientX - s,
                    ...
                    i.event(t).zoom(
                        'mouse',
                        o(_(i.that.__zoom, (i.mouse[0] = In(t, c)), i.mouse[1]), i.extent, f)
                    );
                }
                function d(t) {
            ...
            function S(e, ...i) {
                if (r.apply(this, arguments)) {
                    ...
                    for (rx(e), a = 0; a < s; ++a)
                        (c = [(c = In((u = f[a]), this)), this.__zoom.invert(c), u.identifier]),
                            l.touch0
                                ? l.touch1 || l.touch0[2] === c[2] || ((l.touch1 = c), (l.taps = 0))
            ...
            return (
                ...
                (y.wheelDelta = function (t) {
                    return arguments.length ? ((a = 'function' == typeof t ? t : Qm(+t)), y) : a;
                }),
                (y.filter = function (t) {
                    return arguments.length ? ((r = 'function' == typeof t ? t : Qm(!!t)), y) : r;
                }),
                (y.touchable = function (t) {
                    return arguments.length ? ((u = 'function' == typeof t ? t : Qm(!!t)), y) : u;
                }),
                (y.extent = function (t) {
                    return arguments.length
                        ? ((i =
